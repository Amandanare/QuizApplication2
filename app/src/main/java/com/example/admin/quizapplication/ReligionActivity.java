...
public class ReligionActivity extends AppCompatActivity {
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Toast.makeText(ReligionActivity.this, "It was the last question!", Toast.LENGTH_SHORT).show();
...
//            startActivity(intent);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(ReligionActivity.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(ReligionActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
